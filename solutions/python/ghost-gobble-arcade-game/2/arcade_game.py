...
def eat_ghost(power_pellet_active, touching_ghost):
    ...
    canEat = power_pellet_active and touching_ghost
    return canEat
...
def score(touching_power_pellet, touching_dot):
    ...
    canScore = touching_power_pellet or touching_dot
    return canScore
def lose(power_pellet_active, touching_ghost):
    ...
    isLose = not(power_pellet_active) and touching_ghost
    return isLose
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    isWin = has_eaten_all_dots and not lose(power_pellet_active,touching_ghost)
    return isWin
